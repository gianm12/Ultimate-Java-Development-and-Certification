...
public class Section5_26_TeacherObject extends Section5_26_PersonObject{ //If we made this class final, we wouldn't be able to extend it to 
	//another object...
	private String mSchool;
	private double mBaseSalary;
	private int mNumbYearsAtSchool;
	
	public Section5_26_TeacherObject(String name, String birthDate, String school, double salary, int numYearsAtSchool)
	{
