...
public class Section4_19_TeacherObject extends Section4_19_PersonObject{ //If we made this class final, we wouldn't be able to extend it to 
	//another object...
	private String mSchool;
	private double mBaseSalary;
	private int mNumbYearsAtSchool;
	
	public Section4_19_TeacherObject(String name, String birthDate, String school, double salary, int numYearsAtSchool)
	{
