...
public class Section4_22_PrincipleObject extends Section4_22_PersonObject {
	private Date mJoinDate; //Thd date the principle joined the school

	public Section4_22_PrincipleObject(String personName, String personBirthDate, Date joinDate) {
