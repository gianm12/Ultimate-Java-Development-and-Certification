...
public class Section4_21_AssignmentObject {
	private String mName, mClassName;
	private Date mAssignmentDueDate;//lower case is cause of the instance variable
	
	public Section4_21_AssignmentObject(String name, String className, Date assignmentDueDate)
	{
		mName= name;
	...
	public static Section4_21_AssignmentObject getClosestAssignment(Section4_21_AssignmentObject[] assignments)//making this static, it allows other 
	//classes to access the class and then the method.
	{
		long date = Long.MAX_VALUE;
		Section4_21_AssignmentObject closestAssignment = null;
		for (Section4_21_AssignmentObject assignment : assignments) 
		{
