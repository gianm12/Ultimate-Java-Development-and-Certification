...
public class Section4_23_AssignmentObject {
	private String mName, mClassName;
	private Date mAssignmentDueDate;//lower case is cause of the instance variable
	
	public Section4_23_AssignmentObject(String name, String className, Date assignmentDueDate)
	{
		mName= name;
	...
	public static Section4_23_AssignmentObject getClosestAssignment(Section4_23_AssignmentObject[] assignments)//making this static, it allows other 
	//classes to access the class and then the method.
	{
		long date = Long.MAX_VALUE;
		Section4_23_AssignmentObject closestAssignment = null;
