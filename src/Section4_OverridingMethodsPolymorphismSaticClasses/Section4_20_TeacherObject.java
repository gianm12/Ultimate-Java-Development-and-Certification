...
public class Section4_20_TeacherObject extends Section4_20_PersonObject{ //If we made this class final, we wouldn't be able to extend it to 
	//another object...
	private String mSchool;
	private double mBaseSalary;
	private int mNumbYearsAtSchool;
	
	public Section4_20_TeacherObject(String name, String birthDate, String school, double salary, int numYearsAtSchool)
	{
